	...
	return function e(n, t, r) {
		...
		2: [function(e, n, t) {
			...
			n.exports = a, a.channels = {
				...
				ap: e('./channel/extras/ap')
			}, a.getChannelModule = function(e) {
		...
		3: [function(e, n, t) {
			...
			n.exports = {
				...
				aliAPICall: function() {
					i.call(a, 'jsApiParameters') && AlipayJSBridge.call("tradePay", {
						tradeNO: a.jsApiParameters.tradeNO
					}, function(e) {
						r.innerCallback(e)
					})
				}
		...
		5: [function(e, n, t) {
			...
			function() {
				...
				t.PADCHAR = '=', t.ALPHA = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/', t.makeDOMException = function() {
					...
					a.call(r, 'APURL') && (e.url = r.APURL), window.open(e.url + '?goto=' + i, '_blank')
				}, e.decode = function(e) {
		...
		8: [function(e, n, t) {
			...
			n.exports = {
				...
				callpay: function() {
					var e = this,
						n = i.getExtraModule('wx_jssdk');
					if ('undefined' != typeof n && n.jssdkEnabled()) n.callpay();
				...
				a = n.exports = {
					...
					request: function(e, n, t, i, o, c) {
						if ('undefined' != typeof XMLHttpRequest) {
							...
							'POST' === n ? (u.setRequestHeader('Content-type', 'application/json; charset=utf-8'), u.send(JSON.stringify(t))) : u.send(), 'undefined' == typeof i && (i = function() {}), 'undefined' == typeof o && (o = function() {}), u.onreadystatechange = function() {
					...
					redirectTo: function(e) {
						'undefined' != typeof window && (window.open(e, '_blank'))
					},
